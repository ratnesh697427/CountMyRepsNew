...
function successInSchema()
{
    ...
    dbobj.transaction(insertRecordFAV, errorInsert, SuccessInsert);
...
function insertRecordFAV(tx)
{
    ...
    tx.executeSql("INSERT INTO `FAVRATIO`(`eType`, `eRatio`, `cType`, `cValue`, `tDelay`, `tInterval`, `fName`) VALUES('Workout', '10-30','Sets','3','5','1.5','Pull-ups'), ('Workout', '30-30','Sets','3','5','1','Jumping Jacks'), ('Workout', '20-30','Sets','3','5','0.75','Push-ups'), ('Workout', '30-2','Time','300','5','0.75','Abs of steel'), ('Workout', '120-0','Sets','1','10','1','Front Plank'), ('Workout', '50-60','Sets','5','10','1','Spartan Abs'), ('Workout', '20-60','Sets','3','10','2','Burpees'), ('Workout', '20-2','Time','120','10','1','Abdominal Workout'), ('Breathing', '6-4-6-0','Time','60','5','1','Energizing'), ('Breathing', '6-2-6-0','Sets','4','5','1','Balance'), ('Breathing', '6-1-8-4','Sets','4','10','1','Relax Yoga'), ('Breathing', '4-12-6-0','Sets','5','5','1','Stress release'), ('Breathing', '8-2-10-0','Time','600','5','1','Chi Running'), ('Breathing', '4-7-8-0','Sets','3','10','1','Dr. Weil`s 4-7-8'), ('Breathing', '5-5-5-5','Sets','4','5','1','Advanced Balance'), ('Breathing', '10-8-6-0','Time','300','5','1','Morning Pranayama')",[],SuccessInsert,errorInsert);
    
}

function SuccessInsert(tx,result){
    //navigator.notification.alert('Inserted');
    tx.executeSql("INSERT INTO `ROUTINEZ`(`rName`, `rTime`, `rStatus`) VALUES('Light Morning Workout', 939, 0),('Wake up energizer', 999, 0),('Wake up call', 1316, 0),('Morning Yoga', 673, 0)", [], suceesRTNInsert, errorInsert);
    
}

function suceesRTNInsert(tx,result)
{
    tx.executeSql("INSERT INTO `ROUTINELIST`(`rfName`, `reType`, `reRatio`, `rcType`, `rcValue`, `rcInterval`, `rtInterval`, `rtnID`) VALUES('Pull-ups','Workout','10-30','Sets','3','1.5','60',1),('Jumping Jacks','Workout','30-30','Sets','3','1','20',1),('Push-ups','Workout', '20-30','Sets','3','0.75','10',1),('Burpees','Workout', '20-60','Sets','3','2','5',1),('Energizing','Breathing','6-4-6-0','Time','60','1','5',1),('Balance','Breathing','6-2-6-0','Sets','4','1','10',2),('Burpees','Workout', '20-60','Sets','3','2','10',2),('Chi Running','Breathing', '8-2-10-0','Time','600','1','10',2),('Relax Yoga','Breathing', '6-1-8-4','Sets','4','1','10',3),('Push-ups','Workout', '20-30','Sets','3','0.75','10',3),('Chi Running','Breathing', '8-2-10-0','Time','600','1','10',3),('Burpees','Workout', '20-60','Sets','3','2','10',3),('Stress release','Breathing','4-12-6-0','Sets','5','1','5',3),('Morning Pranayama','Breathing','10-8-6-0','Time','300','1','30',4),('Dr. Weil`s 4-7-8','Breathing','4-7-8-0','Sets','3','1','60',4),('Advanced Balance','Breathing','5-5-5-5','Sets','4','1','20',4),('Relax Yoga','Breathing', '6-1-8-4','Sets','4','1','10',4)", [], suceesRTNInsert2, errorInsert);
}

function suceesRTNInsert2(tx,result)
{
...
function _doUpgradeApp()
{
    ...
    if(navigator.connection.type == 'none'){
        ...
        location.href = 'https://itunes.apple.com/us/app/countmyreps-pro-counts-repetitions/id1114276581?ls=1&mt=8';
...
function successResultsFAV(tx,results)
{
    ...
    if(levelindex == 0){
        if(is_iPad!="")
        {
            $('#favscreen').css('height','618px');
        }
        else
        {
            $('#favscreen').css('height','310px');
        }
        
        $('#favsubdiv').html('<td class="tdtopstyleFR" align="center"><a href="javascript:void(0);" class="activeTab" id="wdiv" onClick="_goFavorites('+"'"+'Workout'+"'"+',0);">WORKOUT</a><a href="javascript:void(0);" class="inactiveTab" id="bdiv" onClick="_goFavorites('+"'"+'Breathing'+"'"+',0);">BREATHING</a><a href="javascript:void(0);" class="inactiveTab" id="rdiv" onClick="_goFavorites('+"'"+'Routines'+"'"+',0);">ROUTINES</a></td>');
        ...
        $('#favsubdiv').html('<td class="tdtopstyleFR" align="center"><a href="javascript:void(0);" class="activeTab" id="wdiv" onClick="_goFavorites('+"'"+'Workout'+"'"+',1);">WORKOUT</a><a href="javascript:void(0);" class="inactiveTab" id="bdiv" onClick="_goFavorites('+"'"+'Breathing'+"'"+',1);">BREATHING</a><a href="javascript:void(0);" class="inactiveTab" id="rdiv" onClick="_goFavorites('+"'"+'Routines'+"'"+',0);">ROUTINES</a></td>');
   ...
   else
   {
       ...
       for(c=0;c<results.rows.length;c++)
       {
           ...
           if(results.rows.item(c).eType=='Workout')
           {
               ...
               if(levelindex == 0){
                   ...
                   wfavlist += '<tr class="ttllst"><td width="62%" align="left"><a href="#" onClick="_doOpenFavorites('+results.rows.item(c).nID+');" style="padding:6px 0px;display:block"><img src="img/circle-play.png" width="24" border="0"/>&nbsp;&nbsp;'+results.rows.item(c).fName+'</a></td><td width="18%" align="left" style="padding-top:3px;"><input type="button" class="favbtn2" id="wbtn'+results.rows.item(c).nID+'" onclick="_doOpenFavDetails('+results.rows.item(c).nID+');" value="Details" /></td><td width="10%" align="right" style="padding-top:5px;"><a onclick="updateFAV('+results.rows.item(c).nID+')"><img src="img/circle-pencil.png" width="24" border="0"/></a></td><td align="right" width="10%" style="padding-top:5px;"><a onclick="deletefmFAV('+results.rows.item(c).nID+','+"'"+'Workout'+"'"+')"><img src="img/circle-cross.png" width="24" border="0"/></a></td></tr><tr class="ttlfav" id="fav'+results.rows.item(c).nID+'"><td>Reps:&nbsp;'+erat[0]+'&nbsp;&nbsp;&nbsp;Rest:&nbsp;'+erat[1]+'&nbsp;&nbsp;&nbsp;'+results.rows.item(c).cType+':&nbsp;'+countValue+''+cUnit+'&nbsp;&nbsp;&nbsp;Interval:&nbsp;'+results.rows.item(c).tInterval+'&nbsp;sec.</td></tr>';
                   
               }else{
                   
                   wfavlist += '<tr class="ttllst"><td width="82%" align="left"><input type="radio" name="favitemID" value="'+results.rows.item(c).nID+'" />&nbsp;&nbsp;'+results.rows.item(c).fName+'</td><td width="18%" align="left" style="padding-top:3px;"><input type="button" class="favbtn2" id="wbtn'+results.rows.item(c).nID+'" onclick="_doOpenFavDetails('+results.rows.item(c).nID+');" value="Details" /></td></tr><tr class="ttlfav" id="fav'+results.rows.item(c).nID+'"><td>Reps:&nbsp;'+erat[0]+'&nbsp;&nbsp;&nbsp;Rest:&nbsp;'+erat[1]+'&nbsp;&nbsp;&nbsp;'+results.rows.item(c).cType+':&nbsp;'+countValue+''+cUnit+'&nbsp;&nbsp;&nbsp;Interval:&nbsp;'+results.rows.item(c).tInterval+'&nbsp;sec.</td></tr>';
           ...
           else
           {
               ...
               if(levelindex == 0){
                   ...
                   bfavlist += '<tr class="ttllst"><td width="62%" align="left"><a href="#" onClick="_doOpenFavorites('+results.rows.item(c).nID+');" style="padding:6px 0px;display:block"><img src="img/circle-play.png" width="24" border="0"/>&nbsp;&nbsp;'+results.rows.item(c).fName+'</a></td><td width="18%" align="left" style="padding-top:3px;"><input type="button" class="favbtn2" id="wbtn'+results.rows.item(c).nID+'" onclick="_doOpenFavDetails('+results.rows.item(c).nID+');" value="Details" /></td><td width="10%" align="right" style="padding-top:5px;"><a onclick="updateFAV('+results.rows.item(c).nID+')"><img src="img/circle-pencil.png" width="24" border="0"/></a></td><td align="right" width="10%" style="padding-top:5px;"><a onclick="deletefmFAV('+results.rows.item(c).nID+','+"'"+'Breathing'+"'"+')"><img src="img/circle-cross.png" width="24" border="0"/></a></td></tr><tr class="ttlfav" id="fav'+results.rows.item(c).nID+'"><td>Inhale:&nbsp;'+erat[0]+'&nbsp;&nbsp;&nbsp;Hold:&nbsp;'+erat[1]+'&nbsp;&nbsp;&nbsp;Exhale:&nbsp;'+erat[2]+'&nbsp;&nbsp;&nbsp;Hold:&nbsp;'+erat[3]+'&nbsp;&nbsp;&nbsp;'+results.rows.item(c).cType+':&nbsp;'+countValue+''+cUnit+'</td></tr>';
                   
               }else{
                   
                   bfavlist += '<tr class="ttllst"><td width="82%" align="left"><input type="radio" name="favitemID" value="'+results.rows.item(c).nID+'" />&nbsp;&nbsp;'+results.rows.item(c).fName+'</a></td><td width="18%" align="left" style="padding-top:3px;"><input type="button" class="favbtn2" id="wbtn'+results.rows.item(c).nID+'" onclick="_doOpenFavDetails('+results.rows.item(c).nID+');" value="Details" /></td></tr><tr class="ttlfav" id="fav'+results.rows.item(c).nID+'"><td>Inhale:&nbsp;'+erat[0]+'&nbsp;&nbsp;&nbsp;Hold:&nbsp;'+erat[1]+'&nbsp;&nbsp;&nbsp;Exhale:&nbsp;'+erat[2]+'&nbsp;&nbsp;&nbsp;Hold:&nbsp;'+erat[3]+'&nbsp;&nbsp;&nbsp;'+results.rows.item(c).cType+':&nbsp;'+countValue+''+cUnit+'</td></tr>';
               }
           }
               ...
               //if(x == 0){$("#noItem").show();}else{$("#noItem").hide();}
                ...
                wfavlist += '</table><br><br>';
                bfavlist += '</table><br><br>';
                $('#savedItemsW').empty();
       ...
       if(exerciseType == 'Workout'){
           ...
           $("#wdiv").removeClass('inactiveTab').addClass('activeTab');
           $("#bdiv").removeClass('activeTab').addClass('inactiveTab');
           $("#rdiv").removeClass('activeTab').addClass('inactiveTab');
           $("#howtocontent").html('To add a Favorite Workout, click Counter then select Workout. Fill in the reps, rest, sets/time, counter interval, start delay and click the "Add to Favorites" button.');
           $("#howtocontent").css('max-width','340px');
           ...
           $("#bdiv").removeClass('inactiveTab').addClass('activeTab');
           $("#wdiv").removeClass('activeTab').addClass('inactiveTab');
           $("#rdiv").removeClass('activeTab').addClass('inactiveTab');
           $("#howtocontent").html('To add a Favorite Breathing exercise, click Counter then select Breathing. Fill in the ratios, start delay and click the "Add to Favorites" button.');
           $("#howtocontent").css('max-width','320px');
...
function openselectedFAV(tx,results){
    ...
    $('#openftype').text(results.rows.item(0).fName);
    $('#wrkout3').text(results.rows.item(0).eType);
    ...
    $('#editbtndiv').html('<button style="width:50%; border-right:2px solid #aeff00;" onClick="_doSaveFavorites('+results.rows.item(0).nID+');" class="actionbtn">SAVE</button><button id="resetTimer" onClick="_goBack('+"'"+tabType+"'"+')"; class="actionbtn" style="width:50%;">BACK</button>');
...
function _goFavorites(index,index2){
    ...
    if(exerciseType == 'Routines')
    {
                              if(is_iPad!="")
                              {
                              $('#favscreen').css('height','568px');
                              }
                              else
                              {
                              $('#favscreen').css('height','258px');
                              }
...
function successResultsRTN(tx,results){
  ...
  $('#favsubdiv').empty();
  $('#favsubdiv').html('<td class="tdtopstyleFR" align="center"><a href="javascript:void(0);" class="activeTab" id="wdiv" onClick="_goFavorites('+"'"+'Workout'+"'"+',0);">WORKOUT</a><a href="javascript:void(0);" class="inactiveTab" id="bdiv" onClick="_goFavorites('+"'"+'Breathing'+"'"+',0);">BREATHING</a><a href="javascript:void(0);" class="inactiveTab" id="rdiv" onClick="_goFavorites('+"'"+'Routines'+"'"+',0);">ROUTINES</a></td>');
  $("#howtocontent").html('Routines are created with 2 or more Favorites. Select any Favorite saved under Workout/Breathing. Set the interval time between each exercise and click the ‘Next‘ button. Repeat the steps, when you are done, click the ‘Save’ button.');
                              $("#howtocontent").css('max-width','360px');
  ...
  else
  {
      ...
      for(c=0;c<results.rows.length;c++)
      {
                              ...
                              //alert(results.rows.item(c).rTime);
        totalRoutineTimeArr[results.rows.item(c).rID] = results.rows.item(c).rTime;
      
        z++;
        rfavlist += '<tr class="ttllst"><td width="72%" align="left"><a href="#" onClick="_doOpenRoutine('+"'"+results.rows.item(c).rID+"'"+','+"'"+results.rows.item(c).rName+"'"+');" style="padding:6px 0px;display:block"><img src="img/circle-play.png" width="24" border="0"/>&nbsp;&nbsp;'+results.rows.item(c).rName+'</a></td><td width="18%" align="left" style="padding-top:3px;"><input type="button" class="favbtn2" id="rbtn'+results.rows.item(c).rID+'" onclick="_doOpenRDetails('+results.rows.item(c).rID+');" value="Details" /></td><td align="right" width="10%" style="padding-top:5px;"><a onclick="_doDelRoutine('+results.rows.item(c).rID+')" valign="middle"><img src="img/circle-cross.png" width="24" border="0"/></a></td></tr><tr><td colspan="3" class="ttlfavr" id="r'+results.rows.item(c).rID+'"></td></tr>';
      ...
      $('#rdiv').removeClass('inactiveTab').addClass('activeTab');
      $('#wdiv').removeClass('activeTab').addClass('inactiveTab');
      $('#bdiv').removeClass('activeTab').addClass('inactiveTab');
...
function getSelectedRdata(tx,resultrd)
{
    ...
    //alert(totalRoutineTimeArr[rtnID]);
    ...
    {
        var executionValue = "Will show after the full execution of the routine";
    }
                              
  var rdetaillist = "";
                              
  rdetaillist = '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="left" colspan="2">Total Items:&nbsp;<span class="rtnDet">'+resultrd.rows.length+'</span></td></tr><tr><td align="left" colspan="2">Execution Time:&nbsp;<span class="rtnDet">'+executionValue+'</span></td></tr><tr><td align="left" colspan="2">Exercises:</td></tr>';
  ...
  for(c=0;c<resultrd.rows.length;c++)
  {
      ...
      rdetaillist += '<tr><td align="left" width="30%" class="rtnDet">'+resultrd.rows.item(c).rfName+'</td><td class="rtnDet">Interval:&nbsp;'+intervalValue+'</td></tr>';
...
function showRoutineItems(tx,result)
{
    ...
    $("#intervalDiv").empty();
    $("#createbtn").empty();
    $("#createbtn").html('<button onClick="_doSelectFAVitem();" class="actionbtn" style="width:50%; border-right:2px solid #aeff00;">ADD MORE ITEM</button><button onClick="_doSelectFAVitem();" class="actionbtn" style="width:50%;">SAVE CHANGES</button>');
...
function _doCreateRoutine()
{
    ...
    if(tmmins > 9){var tmin = tmmins;}else{var tmin = "0"+tmmins;}
    //if(tmin=='00'){sel = 'selected';}else{sel = '';}
    ...
    navigator.notification.confirm(
        'Do you want to delete this routine?',  // message
            function(buttonIndex){
                if(buttonIndex==1)
                {
                dbobj.transaction(removeRTNListRecord, errorInsert, successDB2);
                }
            },                  // callback to invoke
            'Confirm Delete',    // title
            ['Yes','No']          // buttonLabels
...
//Delete item from routine list
function removeRTNListRecord(tx){

    tx.executeSql('DELETE FROM `ROUTINELIST` WHERE `rtnID`='+rtnID, [], removeRecordRTN, errorInsert);
...
function _doSelectFAVitem(){
    ...
    selectedFavItem = $('input:radio[name="favitemID"]:checked').val();
                              //alert(selectedFavItem);

    if(selectedFavItem == "" || selectedFavItem == null){
    ...
    {
        $("#createbtn").html('<button onClick="_doSelectFAVitem();" class="actionbtn" style="width:50%; border-right:2px solid #aeff00;">NEXT</button><button onClick="_doSaveRoutine();" class="actionbtn" style="width:50%;">SAVE</button>');
    }
...
function _doOpenRoutine(index, index2='')
{
...
function getRoutineItem1Data(tx,result)
{
    ...
    $('#typespanf').text(result.rows.item(0).rfName);
    $('#wrkout3').text(result.rows.item(0).reType);
    ...
    if(result.rows.item(0).reType == 'Workout'){
        ...
        $('#sliderFF').show();
        $('#openItem').html('<tr><td align="left" class="tdstyle" style="border-top:none;"># Reps</td><td align="right" class="tdstyle" style="border-top:none;"><span style="color:#fff;">'+exratio[0]+'</span></td></tr><tr><td align="left" class="tdstyle">Rest</td><td class="tdstyle" align="right"><span style="color:#fff;">'+exratio[1]+'</span></td></tr>');

    }else{

        $('#sliderFF').hide();
        $('#openItem').html('<tr><td align="left" class="tdstyle" style="border-top:none;">Inhale</td><td align="right" class="tdstyle" style="border-top:none;"><span style="color:#fff;">'+exratio[0]+'</span></td></tr><tr><td align="left" class="tdstyle">Hold</td><td align="right" class="tdstyle"><span style="color:#fff;">'+exratio[1]+'</span></td></tr><tr><td align="left" class="tdstyle">Exhale</td><td align="right" class="tdstyle"><span style="color:#fff;">'+exratio[2]+'</span></td></tr><tr><td align="left" class="tdstyle">Hold</td><td align="right" class="tdstyle"><span style="color:#fff;">'+exratio[3]+'</span></td></tr>');
    ...
    $('#favbtndiv').empty();
    $('#favbtndiv').html('<button style="width:50%; border-right:2px solid #aeff00;" onClick="_doStartFavorites('+"'"+dbstring+"'"+','+"'"+result.rows.item(0).reRatio+"'"+','+"'"+result.rows.item(0).rcValue+"'"+','+"'"+'Routines'+"'"+');" class="actionbtn">START</button><button onClick="_goFavorites('+"'"+'Routines'+"'"+',0);" class="actionbtn" style="width:50%;">BACK</button>');
...
function selectType(typeID){
    ...
    $("#btndiv2").html('<button onClick="_doStartCounter();" class="actionbtn">START</button>');
    ...
    if(typeID == 'brthing'){
        ...
        $("#intervaldiv").empty();
        $("#intervaldiv").html('<select id="iSlider" class="ddbox" onclick="showUpgrade()"><option value="1">1.00&nbsp;sec.</option></select>');
        $("#delaydiv").empty();
        $("#delaydiv").html('<select id="dSlider" class="ddbox" onclick="showUpgrade()"><option value="0" selected>00:10</option></select>');
                                  $("#settimerDigits").val('0');
                                  $("#settimerradio").prop('selectedIndex', 0);
                                  $("#settimerdiv").empty();
    ...
    $("#exercisediv").empty();
    $("#exercisediv").html('<tr><td class "tdstyle" width="50%" align="left" style="padding-top:15px; border:none;">HOURS  </td><td align="right" style="padding-top:15px; border:none;" class="tdstyle"><select id="sli" class="ddbox" ><option value="00">HH</option></select></td></tr><tr><td align="left" style="padding-top:15px;" class="tdstyle">Minutes</td><td align="right" style="padding-top:15px;" class="tdstyle"><select id="sli2" class="ddbox" ><option value="00">MM</option></select></td></tr><tr><td align="left" style="padding-top:15px;" class="tdstyle">Seconds</td><td align="right" style="padding-top:15px;" class="tdstyle"><select id="sli3" class="ddbox" ><option value="00">SS</option></select></td></tr> ')
                                  
                                  navigator.notification.alert("HII");
                                  for (i=0;i<=100;i++){
        ...
        //$('#iSlider').show();
                                  ...
                                  $('#sttimetd').hide();
                                  $('.favbtn').show();
                                  $('#cntrm').html('00:00.<span id="cms">00</span>');
                                  exerciseType = 'Timer';
        ...
        $('.favbtn').hide();
        $('#cntrm').html('00:00.<span id="cms">00</span>');
        exerciseType = 'Stopwatch';
    }
                                  
    $('.activeTab').removeClass('activeTab').addClass('inactiveTab');
    $('#'+typeID).removeClass('inactiveTab').addClass('activeTab');
...
$('#settimerradio').change(
    ...
    if(this.value == 'Sets'){
        ...
        $("#settimerdiv").empty();
        $("#settimerdiv").html('<select id="setminDigits" class="ddbox"><option value="mm" Selected>Min</option>'+minDropdown+'</select><select id="setsecDigits" class="ddbox"><option value="ss" Selected>Sec</option>'+secDropdown+'</select>');
...
function successResultFAV(tx,result){
    ...
    $('#wrkout3').text(result.rows.item(0).eType);
    $('#typespanf').text(result.rows.item(0).fName);
    $('#typespan').text(result.rows.item(0).fName);
                                  
                                  tabType =result.rows.item(0).eType;
    ...
    $('#favbtndiv').html('<button style="width:50%; border-right:2px solid #aeff00;" onClick="_doStartFavorites('+"'"+dbstring+"'"+','+"'"+result.rows.item(0).eRatio+"'"+','+"'"+result.rows.item(0).cValue+"'"+','+"'"+result.rows.item(0).eType+"'"+');" class="actionbtn">START</button><button id="resetTimer" onClick="_goBack('+"'"+tabType+"'"+')"; class="actionbtn" style="width:50%;">BACK</button>');
...
{
$("#btndiv2").html("<button id='pauseTimer' onClick='stopStopWatchTimer();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>STOP</button><button id='resetTimer' href='#' onClick=resetStopWatchTimer() class='actionbtn' style='width:50%;'>RESET</button>");
                                  
    stopwatchtimer = setInterval(function(){

        $("#cntrm").html(msToTime(swms));
        swms++;
...
{
    $("#btndiv2").html("<button id='pauseTimer' onClick='startStopWatch();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>START</button><button id='resetTimer' href='#' onClick=resetStopWatchTimer() class='actionbtn' style='width:50%;'>RESET</button>");
...
function startStopWatch()
{
    ...
    $("#btndiv2").html("<button id='pauseTimer' onClick='stopStopWatch();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>STOP</button><button id='resetTimer' href='#' onClick=resetStopWatch() class='actionbtn' style='width:50%;'>RESET</button>");
}

function stopStopWatch()
{
    clearInterval(stopwatch);
    $("#btndiv2").html("<button id='pauseTimer' onClick='startStopWatch();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>START</button><button id='resetTimer' href='#' onClick=resetStopWatch() class='actionbtn' style='width:50%;'>RESET</button>");
}
...
function runStopWatch()
{
    ...
    $("#cntrm").html(tm+":"+ts+".<span id='cms'>"+tms+"</span>");
...
function _doStartCounter(){
    ...
    delaysecs = 10; //($('#dSlider option:selected').val()=="")? 10 : $('#dSlider option:selected').val();
    timeInterval = 1; //$('#iSlider option:selected').val();
    
    tabType = 'Counter';
    $('#tabspan').empty();
    $('#tabspan').text(tabType);
    if(exerciseType == 'Stopwatch')
    {
        startStopWatch();
    }
                                  ...
                                  {
                                  var hoursDigits = $('#sli').val();
                                  var minsDigits = $('#sli2').val();
                                  var secDigits = $('#sli3').val();
                                  exerciseStr = hoursDigits+'-'+minsDigits+'-'+secDigits;
                                  startTimerWatch();
        ...
        if(countType == 'Time'){
            ...
            if(countValmin == 'mm' && countValsec == 'ss'){
                navigator.notification.alert('Please select either minute or second from the Time dropdown');
                $('#setminDigits').focus();
                return false;
            }
            else if(countValmin == '0' && countValsec == '0')
            {
                navigator.notification.alert('Please select either minute or second from the Time dropdown');
                $('#setminDigits').focus();
                return false;
            }
            else if(countValmin == 'mm' && countValsec == '0')
            {
                navigator.notification.alert('Please select either minute or second from the Time dropdown');
                $('#setminDigits').focus();
                return false;
            }
            else if(countValmin == '0' && countValsec == 'ss')
            {
                navigator.notification.alert('Please select either minute or second from the Time dropdown');
                $('#setminDigits').focus();
                return false;
            }
            else if(countValmin == 'mm' && countValsec != '0' && countValsec != 'ss')
            {
                countValmin = 0;
            }
            else if(countValsec == 'ss' && countValmin != '0' && countValmin != 'mm')
            {
                countValsec = 0;
            }
        ...
        $('#typespan').empty();
        $('#wrkout2').empty();
        $('#wrkout2').removeClass('inactiveTab').addClass('activeTab');
        $('#wrkout2').text(exerciseType);
        $('#cntr').empty();
        $('#cntr').text('0');
...
function delay2ready(wp) {
    ...
    if(tabType == 'Counter')
    {
        ...
        $("#btndiv").html("<button id='pauseTimer' onClick='pauseStartDealy();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>PAUSE</button><button id='resetTimer' href='#' onClick=_goBack('"+tabType+"') class='actionbtn' style='width:50%;'>RESET</button>");
        ...
        if(FavItemType == 'Routines')
        {
            ...
            $("#btndiv").html("<button id='pauseTimer' onClick='pauseStartDealy();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>PAUSE</button><button id='resetTimer' onClick=_doOpenRoutine("+rtnID+") class='actionbtn' style='width:50%;'>RESET</button>");
                                  
        }else{
                                  
            $("#btndiv").html("<button id='pauseTimer' onClick='pauseStartDealy();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>PAUSE</button><button id='resetTimer' href='#' onClick=_doOpenFavorites("+favID+") class='actionbtn' style='width:50%;'>RESET</button>");
    ...
    if(exerciseType == 'Workout'){
        ...
        $('#edetaildiv').empty();
        $('#edetaildiv').html('<tr><td align="left" class="tdstyle" style="border-top:none;"># Reps</td><td align="right" class="tdstyle" style="border-top:none;"><span style="color:#fff;">'+valarr[0]+'</span></td></tr><tr><td align="left" class="tdstyle">Rest</td><td class="tdstyle" align="right"><span style="color:#fff;">'+valarr[1]+'</span></td></tr>');
        ...
        $('#cntrIntVal').empty();
        $('#edetaildiv').empty();
        $('#edetaildiv').html('<tr><td align="left" class="tdstyle" style="border-top:none;">Inhale</td><td align="right" class="tdstyle" style="border-top:none;"><span style="color:#fff;">'+valarr[0]+'</span></td></tr><tr><td align="left" class="tdstyle">Hold</td><td align="right" class="tdstyle"><span style="color:#fff;">'+valarr[1]+'</span></td></tr><tr><td align="left" class="tdstyle">Exhale</td><td align="right" class="tdstyle"><span style="color:#fff;">'+valarr[2]+'</span></td></tr><tr><td align="left" class="tdstyle">Hold</td><td align="right" class="tdstyle"><span style="color:#fff;">'+valarr[3]+'</span></td></tr>');
...
function getRoutineItemData(tx,resultsRN)
{
    ...
    $("#totalCount").empty();
    $("#typespan").empty();
    $("#typespan").text(routineItemName);
    $("#tabspan").text(routineListName);
    $("#btndiv").empty();
...
function startWatch(e1,e2) {
    ...
    if(tabType == 'Counter')
    {
        ...
        $("#btndiv").html("<button id='pauseTimer' onClick='pauseWatch();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>PAUSE</button><button id='resetTimer' onClick=_goBack('"+tabType+"') class='actionbtn' style='width:50%;'>RESET</button>");
        ...
        if(FavItemType == 'Routines'){
            ...
            $("#btndiv").html("<button id='pauseTimer' onClick='pauseWatch();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>PAUSE</button><button id='resetTimer' onClick=_doOpenRoutine("+rtnID+") class='actionbtn' style='width:50%;'>RESET</button>");

        }else{

            $("#btndiv").html("<button id='pauseTimer' onClick='pauseWatch();' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>PAUSE</button><button id='resetTimer' onClick=_doOpenFavorites("+favID+") class='actionbtn' style='width:50%;'>RESET</button>");
...
function pauseWatch()
{
    ...
    if(tabType == 'Counter')
    {
        ...
        $("#btndiv").html("<button id='resumeTimer' onClick='_goTimer("+'"r"'+","+secs+");startWatch("+k+","+j+");' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>START</button><button id='resetTimer' onClick=_goBack('"+tabType+"') class='actionbtn' style='width:50%;'>RESET</button>");
        ...
        if(FavItemType == 'Routines'){
            ...
            $("#btndiv").html("<button id='resumeTimer' onClick='startClock();_goTimer("+'"r"'+","+secs+");startWatch("+k+","+j+");' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>START</button><button id='resetTimer' onClick=_doOpenRoutine("+rtnID+") class='actionbtn' style='width:50%;'>RESET</button>");

        }else{

            $("#btndiv").html("<button id='resumeTimer' onClick='_goTimer("+'"r"'+","+secs+");startWatch("+k+","+j+");' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>START</button><button id='resetTimer' onClick=_doOpenFavorites("+favID+") class='actionbtn' style='width:50%;'>RESET</button>");
...
function pauseStartDealy(){
    ...
    if(tabType == 'Counter')
    {
        ...
        $("#btndiv").html("<button id='resumeTimer' onClick='delay2ready("+delaysecs+");' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>START</button><button id='resetTimer' onClick=_goBack('"+tabType+"') class='actionbtn' style='width:50%;'>RESET</button>");

    }else{

        if(FavItemType == 'Routines'){
            
            $("#btndiv").html("<button id='resumeTimer' onClick='startClock();delay2ready("+delaysecs+");' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>START</button><button id='resetTimer' onClick=_doOpenRoutine("+rtnID+") class='actionbtn' style='width:50%;'>RESET</button>");

        }else{
        
            $("#btndiv").html("<button id='resumeTimer' onClick='delay2ready("+delaysecs+");' class='actionbtn' style='width:50%; border-right:2px solid #aeff00;'>START</button><button id='resetTimer' onClick=_doOpenFavorites("+favID+") class='actionbtn' style='width:50%;'>RESET</button>");
...
{
                                  //alert(upseconds);
    if(voiceLang == 'en-US'){var vocaltext = "Routine Complete";}
    else if(voiceLang == 'es-ES'){var vocaltext = "Rutina Completa";}
    else if(voiceLang == 'zh-CN'){var vocaltext = "例行过";}
    else if(voiceLang == 'hi-IN'){var vocaltext = "रोटीन समाप्त";}
    else if(voiceLang == 'ar-AE'){var vocaltext = "روتين أكثر";}
    else if(voiceLang == 'pt-PT'){var vocaltext = "Rotina Completo";}
    else if(voiceLang == 'ja-JP'){var vocaltext = "ルーチンオーバー";}
    else if(voiceLang == 'ru-RU'){var vocaltext = "Рутинное завершение";}
    else if(voiceLang == 'fr-FR'){var vocaltext = "Routine Complete";}
...
function _doFeed()
{
   ...
   $.ajax({
          ...
          type: 'POST',
          data: {userName:userName,userEmail:userEmail,userFeed:userFeed,userNews:userNews,userNews2:userNews2,deviceFrm:'Apple Free',feedbtn:feedbtn},
...
function _doShare(){
    ...
    if(navigator.connection.type == 'none'){
        ...
        window.plugins.socialsharing.share("Check out the CountMyReps App - anytime, anywhere. You work out and we'll count! - (https://itunes.apple.com/us/app/countmyreps-voice-counter-gym-yoga/id1102802911?mt=8)", "Message from CountMyReps App");
...
/************************************** Routine ************************************************/
 ...
 /***************************TimerStopWatch*******************************************/
        ...
        {
                               navigator.notification.alert('Please select");
                               if(select == 0 && select2 == 0 && select3 == 0 ){
                               navigator.notification.alert('Please select either hours minute or second from the Time dropdown');
                               }
                               ...
                               delay2ready2(delaysecs);
                               
                               
                               }}
                                  
                                  
/***************************delay for timer screen*******************************************************/
                               
                               
                               
                               function delay2ready2(wp) {
                               ...
                               {
                               tagArr = ["Hours","Minutes","Seconds"];
                               $('#CntrIntDiv').hide();
                               $('#cntrIntVal').empty();
                               $('#edetaildiv').empty();
                               $('#edetaildiv').html('<tr><td align="left" class="tdstyle" style="border-top:none;">Hours</td><td align="right" class="tdstyle" style="border-top:none;"><span style="color:#fff;">'+valarr[0]+'</span></td></tr><tr><td align="left" class="tdstyle">Minutes</td><td align="right" class="tdstyle"><span style="color:#fff;">'+valarr[1]+'</span></td></tr><tr><td align="left" class="tdstyle">Seconds</td><td align="right" class="tdstyle"><span style="color:#fff;">'+valarr[2]+'</span></td></tr>');
